...
(function ($) {
    ...
    $.fn.fileinputLocales['bg'] = {
        ...
        msgFilesTooMany: 'Броя файлове избрани за качване <b>({n})</b> надвишава ограничението от максимум <b>{m}</b>.',
        ...
        fileActionSettings: {
            removeTitle: 'Изтрий файл',
            uploadTitle: 'Качване на файл',
            indicatorNewTitle: 'Все още не е качен',
            indicatorSuccessTitle: 'Качен успешно',
