FashionLime.Admin.Campaign.outfit = (function() {
  'use strict';

  var publicData = {

    get: function(outfit) {
      var partial = FashionLime.Outfit.partial.get(outfit, "medium");
      return (
        ...
        '<span class="campaign-object-id" style="display: none;">' + outfit.id + '</span>' +
